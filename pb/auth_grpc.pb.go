...
const (
	...
	AuthService_UpdateUserDetails_FullMethodName = "/pb.AuthService/UpdateUserDetails"
)
...
func (c *authServiceClient) UpdateUserDetails(ctx context.Context, in *UpdateUserDetailsRequest, opts ...grpc.CallOption) (*UpdateUserDetailsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_UpdateUserDetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
